"""
   VirusTotalAPIIPAddresses class testing module.
...
class TestIPAddresses(unittest.TestCase):
    ...
    def test_get_report(self):
        vt_ip = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip.get_report('test_ip')
    ...
    def test_get_report_wrong_api_key(self):
        vt_ip_wrong_api_key = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip_wrong_api_key.get_report('test_ip')
    ...
    def test_get_comments_wrong_api_key(self):
        vt_ip_wrong_api_key = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip_wrong_api_key.get_comments('test_ip')
        http_err = vt_ip_wrong_api_key.get_last_http_error()
        self.assertEqual(http_err, vt_ip_wrong_api_key.HTTP_AUTHENTICATION_REQUIRED_ERROR)
    ...
    def test_put_comments(self):
        vt_ip = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip.put_comments('test_ip', 'test_comment')
        http_err = vt_ip.get_last_http_error()
        self.assertEqual(http_err, vt_ip.HTTP_OK)
    ...
    def test_put_comments_wrong_api_key(self):
        vt_ip_wrong_api_key = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip_wrong_api_key.put_comments('test_ip', 'test_comment')
        http_err = vt_ip_wrong_api_key.get_last_http_error()
        self.assertEqual(http_err, vt_ip_wrong_api_key.HTTP_AUTHENTICATION_REQUIRED_ERROR)
    ...
    def test_get_votes_wrong_api_key(self):
        vt_ip_wrong_api_key = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip_wrong_api_key.get_votes('test_ip')
        http_err = vt_ip_wrong_api_key.get_last_http_error()
        self.assertEqual(http_err, vt_ip_wrong_api_key.HTTP_AUTHENTICATION_REQUIRED_ERROR)
    ...
    def test_put_votes_wrong_api_key(self):
        vt_ip_wrong_api_key = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip_wrong_api_key.put_votes('test_ip')
        http_err = vt_ip_wrong_api_key.get_last_http_error()
        self.assertEqual(http_err, vt_ip_wrong_api_key.HTTP_AUTHENTICATION_REQUIRED_ERROR)
    ...
    def test_get_relationship(self):
        vt_ip = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip.get_relationship('test_ip')
        http_err = vt_ip.get_last_http_error()
        self.assertEqual(http_err, vt_ip.HTTP_OK)
    ...
    def test_get_relationship_wrong_api_key(self):
        vt_ip_wrong_api_key = VirusTotalAPIIPAddresses('test_api_key')
        vt_ip_wrong_api_key.get_relationship('test_ip')
        http_err = vt_ip_wrong_api_key.get_last_http_error()
        self.assertEqual(http_err, vt_ip_wrong_api_key.HTTP_AUTHENTICATION_REQUIRED_ERROR)
